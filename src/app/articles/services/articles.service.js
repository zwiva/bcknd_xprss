...
const create = async (article, id_user) => { // Crea artículo si corresponde según el rol
  try {
    if (
      ...
      return handlerHttpResponse(400, null, 'Solicitud errónea. Se requieren las siguientes propiedades para crear un artículo: Título, Resumen, Url imagen principal, Enlace complementario, y/o Sección');
